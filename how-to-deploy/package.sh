...
case `uname -s` in
    Darwin)
        sed -i "" "s/DCC_VISUALISE_VERSION/${version}/g" src/main/webapp/deploy.sh;
        sed -i "" "s/DCC_VISUALISE_VERSION/${version}/g" src/main/webapp/index.jsp;
        sed -i "" "s/DCC_VISUALISE_VERSION/${version}/g" src/main/webapp/js/visualise.js;
        ;;
    *)
        sed -i "s/DCC_VISUALISE_VERSION/${version}/g" src/main/webapp/deploy.sh;
        sed -i "s/DCC_VISUALISE_VERSION/${version}/g" src/main/webapp/index.jsp;
